...
export const RELIC_DEFINITIONS: Readonly<Record<string, RelicDefinition>> = {
  ...
  'cracked-core': {
    id: 'cracked-core',
    name: 'Cracked Core',
    description: 'Al inicio de tu turno, gana 1 de energía.',
    rarity: 'starter',
  ...
  'pure-water': {
    id: 'pure-water',
    name: 'Pure Water',
    description: 'Al entrar en un descanso, cura 6 HP.',
    rarity: 'starter',
  ...
  vajra: {
    id: 'vajra',
    name: 'Vajra',
    description: 'Al entrar en un nodo, gana 1 de Fuerza.',
    rarity: 'common',
    passiveHooks: [
      {
        hook: 'map-node-enter',
  ...
  akabeko: {
    id: 'akabeko',
    name: 'Akabeko',
    description: 'Al inicio de tu turno, gana 2 de bloque.',
    rarity: 'common',
  ...
  'ancient-tea-set': {
    ...
    description: 'Al entrar en un nodo, gana 1 de energía.',
    rarity: 'common',
  ...
  'art-of-war': {
    id: 'art-of-war',
    name: 'Art of War',
    description: 'Al entrar en un descanso, gana 3 de bloque.',
    rarity: 'common',
  ...
  'bag-of-marbles': {
    id: 'bag-of-marbles',
    name: 'Bag of Marbles',
    description: 'Al inicio de tu turno, roba 1 carta.',
    rarity: 'common',
  ...
  'blood-vial': {
    id: 'blood-vial',
    name: 'Blood Vial',
    description: 'Al entrar en un descanso, roba 1 carta.',
    rarity: 'common',
  ...
  'bronze-scales': {
    id: 'bronze-scales',
    name: 'Bronze Scales',
    description: 'Al entrar en un nodo, gana 2 de bloque.',
    rarity: 'common',
  ...
  'centennial-puzzle': {
    ...
    description: 'Al entrar en un nodo, obtén +1 reliquia al vencer elites.',
    rarity: 'common',
    passiveHooks: [
      {
        hook: 'map-node-enter',
  ...
  'ceramic-fish': {
    id: 'ceramic-fish',
    name: 'Ceramic Fish',
    description: 'Al inicio de tu turno, gana 2 de Espinas.',
    rarity: 'common',
    passiveHooks: [
      {
  ...
  'dream-catcher': {
    id: 'dream-catcher',
    name: 'Dream Catcher',
    description: 'Al entrar en un descanso, gana 1 de energía.',
    rarity: 'common',
  ...
  'happy-flower': {
    id: 'happy-flower',
    name: 'Happy Flower',
    description: 'Al entrar en un nodo, roba 1 carta.',
    rarity: 'common',
  ...
  'juzu-bracelet': {
    id: 'juzu-bracelet',
    name: 'Juzu Bracelet',
    description: 'Al inicio de tu turno, gana 1 de bloque.',
    rarity: 'common',
  ...
  'meat-on-the-bone': {
    ...
    description: 'Al entrar en un descanso, cura 8 HP.',
    rarity: 'uncommon',
  ...
  omamori: {
    id: 'omamori',
    name: 'Omamori',
    description: 'Al entrar en un descanso, gana 1 de Artefacto.',
    rarity: 'common',
    passiveHooks: [
  ...
  'pen-nib': {
    id: 'pen-nib',
    name: 'Pen Nib',
    description: 'Al inicio de tu turno, roba 2 cartas.',
    rarity: 'uncommon',
  ...
  'regal-pillow': {
    id: 'regal-pillow',
    name: 'Regal Pillow',
    description: 'Al entrar en un descanso, cura 5 HP.',
    rarity: 'common',
  ...
  'the-boot': {
    id: 'the-boot',
    name: 'The Boot',
    description: 'Al entrar en un nodo, gana 1 de bloque.',
    rarity: 'common',
  ...
  whetstone: {
    id: 'whetstone',
    name: 'Whetstone',
    description: 'Al entrar en un descanso, gana 2 de bloque.',
    rarity: 'common',
